...
const fixTopBBCStory = () => {
  ...
  topStoryTitleEl.innerText = "Nicolas becomes favourite Off the Rails instructor."
}
...
function fixTweet () {
  ...
  tweetText.innerText = "I just can't believe how quickly Nicolas became favourite Off the Rails lead instructor ever. This is huge! So proud, I'm so proud."
}
